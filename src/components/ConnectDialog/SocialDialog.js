...
const SocialDialog = ({ modalVisible, toggleDialog, setSocialLogged, toggleCreate }) => {
      ...
      >
        <div className="connect-dialog">
          ...
          <div className="connect-container">
            ...
            <h3>
              Login with one of your social media account
            </h3>
          ...
          <h3>We do not share your account details to anyone. We care about your privacy</h3>
          </div>
}
        </div>
      </Modal>
